...
import { ExtensionLoaderParameter, AlexaExtension, AdvancedAPLExtension, AlexaAudioPlayerExtension, AlexaMonetizationExtension } from '@alexa-games/sfb-skill';
...
export class ExtensionLoader {
    ...
    constructor(param: ExtensionLoaderParameter) {
        this.registeredExtensions = [
            ...
            new AlexaExtension(),
            new AdvancedAPLExtension(param.locale, param.configAccessor),
